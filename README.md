...
The <b>IPA Tracker Support Center</b> provides information and technical assistance to participating community partners, researchers, and study staff who are piloting the use of the <b>IPA Tracker</b>, a secure, cloud-based tool designed to inform and documment their efforts to implement community-driven SMART Strategies, with additional functionality allowing authorized users to download selected data for reporting on various implementation process and outcomes metrics. 
